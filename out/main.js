...
module.exports = function (argv) {
    ...
    program
        ...
        .action(({ out, githubBranch, baseContentUrl, baseImagesUrl, yarn, ignoreFile, noGitHubIssueLinking, web }) => main(package_1.packageCommand({
        packagePath: out,
        githubBranch,
        baseContentUrl,
        baseImagesUrl,
    ...
    program
        ...
        .option('--ignoreFile [path]', 'Indicate alternative .vscodeignore')
        .option('--web', 'Experimental flag to enable publishing web extensions. Note: This is supported only for selected extensions.')
        .action((version, { pat, message, packagePath, githubBranch, baseContentUrl, baseImagesUrl, yarn, noVerify, ignoreFile, web }) => main(publish_1.publish({
        pat,
